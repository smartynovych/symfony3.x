 ...
 * MsgParserInterfaces
 *
 * @ORM\Table(name="msg_parser_interfaces")
 * @ORM\Entity(repositoryClass="MsgParserBundle\Repository\MsgParserInterfacesRepository")
 */
class MsgParserInterfaces
{
    /**
     * @var int
     *
